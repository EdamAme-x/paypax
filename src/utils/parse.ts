...
export function parseGetLink(result: Anyone, success: boolean): ResponseGetLink {
  try {
    ...
    return {
      ...
      emoney_amount: result.payload.message.data.subWalletSplit.senderEmoneyAmount ?? 0,
      prepaid_amount: result.payload.message.data.subWalletSplit.senderPrepaidAmount ?? 0,
